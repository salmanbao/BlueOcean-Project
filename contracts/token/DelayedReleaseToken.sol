/*
  ...
  Used in our case to allow the BlueOcean token to be instantiated, then the BlueOcean DAO instantiated using the BlueOcean token as the share token, then an amount of BOT to be minted to the DAO.
